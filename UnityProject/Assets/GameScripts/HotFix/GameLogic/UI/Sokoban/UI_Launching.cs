...
namespace GameLogic
{
    ...
    class UI_Launching : UIWindow
    {
        ...
        public override void ScriptGenerator()
        {
            ...
            _Btn_Right   = FindChildComponent<Button>("_Btn_Right");
            _Btn_Up      = FindChildComponent<Button>("_Btn_Up");
            _Btn_Down    = FindChildComponent<Button>("_Btn_Down");
            _Btn_Left    = FindChildComponent<Button>("_Btn_Left");
